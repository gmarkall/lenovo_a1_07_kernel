/*
 * s5k5ca.h - Shared settings for the S5K5CA CameraChip.
 *
 * Contributors: 
 *   cdpg 
 *
...
/*
I2C_ID
Slave Address (7-bit + read mode)
Slave Address (7-bit + write mode)
Comment
0
0111_1001b / 79h
0111_1000b / 78h
MIPI CSI-2 CCI Slave Address 1
1
0101_1011b / 5Bh
0101_1010b / 5Ah
Default Address 1
...
//#define S5K5CA_I2C_ADDR 0x3C
#define S5K5CA_I2C_ADDR 0x2D

/* Average black level */
#define S5K5CA_BLACK_LEVEL_AVG	64

/**
 * struct s5k5ca_platform_data - platform data values and access functions
