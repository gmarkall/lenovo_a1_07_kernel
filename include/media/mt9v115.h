/*
 * mt9v115.h - Shared settings for the MT9V115 CameraChip.
 *
 * Contributors: 
 *   cdpg 
 *
...
#define MT9V115_I2C_ADDR 0x3d

/* Average black level */
#define MT9V115_BLACK_LEVEL_AVG	64

/**
 * struct mt9v115_platform_data - platform data values and access functions
 * @power_set: Power state access function, zero is off, non-zero is on.
 * @default_regs: Default registers written after power-on or reset.
 * @ifparm: Interface parameters access function
 * @priv_data_set: device private data (pointer) access function
 */
struct mt9v115_platform_data {
