/*
 * mt9d115.h - Shared settings for the MT9D115 CameraChip.
 *
 * Contributors: 
 *   cdpg 
 *
...
/* Average black level */
#define MT9D115_BLACK_LEVEL_AVG	64

/**
 * struct mt9d115_platform_data - platform data values and access functions
