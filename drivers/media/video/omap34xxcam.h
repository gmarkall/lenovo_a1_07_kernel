...
#define OMAP34XXCAM_SLAVE_SENSOR0	0
#define OMAP34XXCAM_SLAVE_SENSOR1	1
#define OMAP34XXCAM_SLAVE_LENS		2
#define OMAP34XXCAM_SLAVE_FLASH		3 /* This is the last slave! */

/* mask for omap34xxcam_slave_power_set */
#define OMAP34XXCAM_SLAVE_POWER_SENSOR0	(1 << OMAP34XXCAM_SLAVE_SENSOR0)
#define OMAP34XXCAM_SLAVE_POWER_SENSOR1	(1 << OMAP34XXCAM_SLAVE_SENSOR1)
#define OMAP34XXCAM_SLAVE_POWER_SENSOR	((1 << OMAP34XXCAM_SLAVE_SENSOR0) | (1 << OMAP34XXCAM_SLAVE_SENSOR1))
...
//extern unsigned int first_time; 	/* &*&*&*CJ1_20110610 for improve captrure performance */
 ...
 * @current_sensor: the sensor which being used
...
#define vdev_sensor0 slave[OMAP34XXCAM_SLAVE_SENSOR0]
#define vdev_sensor1 slave[OMAP34XXCAM_SLAVE_SENSOR1]
...
#define vdev_sensor_config0 slave_config[OMAP34XXCAM_SLAVE_SENSOR0].u.sensor
#define vdev_sensor_config1 slave_config[OMAP34XXCAM_SLAVE_SENSOR1].u.sensor
