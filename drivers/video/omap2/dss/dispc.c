			...
			u16 height, u16 out_width, u16 out_height)
{
	...
	/* FIXME venc pclk? */
	DSSERR("dispc_pclk_rate(channel) * vf * hf = %d * %lu * %lu, channel=%d \n", dispc_pclk_rate(channel), vf, hf, channel);
				...
				u16 *x_decim, u16 *y_decim, bool *three_tap)
{
	...
	while (1) {
		...
		//printk("*****************before the in_width is %d ...\n, the in_height is %d ...\n", in_width, in_height);
		...
		//printk("*****************after the in_width is %d ...\n, the in_height is %d ...\n", in_width, in_height);
		...
		//printk("********************before calc_fclk the three_tap value is %d ...\n", *three_tap);
		fclk = *three_tap ?
...
/* 		printk("*****************Scaling: %d*%d,%d*%d->%d,%d 3taps=%d\n", in_width, x,
			in_height, y, out_width, out_height, *three_tap);
		printk("******************required fclk= %lu Hz - fclk= %lu - pclk= %lu channel= %u\n",
...
loop:
	...
	*x_decim = x;
	*y_decim = y;
	//printk("*********************the *x_decim is %d , the *y_decim is %d ...\n", *x_decim, *y_decim);
	return 0;
}
