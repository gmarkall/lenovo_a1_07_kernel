...
static int dss_get_clocks(void)
{
	...
	if (cpu_is_omap44xx()) {
		...
		r = dss_get_clock(&core.dss_ick, "dss_ick2");//&*&*&*JJ_20110420
		if (r)
			goto err;
		...
		if (r)
			goto err;
                ...
                r = dss_get_clock(&core.dss2_fck, "dss2_alwon_fck");//&*&*&*JJ_20110420
		if (r)
			goto err;

		r = dss_get_clock(&core.dss_54m_fck, "dss_tv_fck");//&*&*&*JJ_20110420
		if (r)
			goto err;

                r = dss_get_clock(&core.dss_96m_fck, "dss_96m_fck");//&*&*&*JJ_20110420
		if (r)
			goto err;
	}
...
static int omap_dss_probe(struct platform_device *pdev)
{
	...
	int r = 0;
	int i;
	bool skip_init = true;//&*&*&*JJ_20110420
