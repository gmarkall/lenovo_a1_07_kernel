...
#define AIC3111_RATES	( SNDRV_PCM_RATE_44100 )
...
/*ADC Processing Blocks Selection*/
#define ADC_PRO_BLOCKS_SELCT   61
...
#define TIMER_CLOCK_MCLK_DRIVER     (PAGE_3+16)
/***************** Page 4 Registers******************************************/
#define PAGE_4                     512
/*8 MSBs of N0 coefficient for ADC-programmable first-order IIR*/
#define MSBS_N0_ADC_IIR            	(PAGE_4+8)
/*8 LSBs of N0 coefficient for ADC-programmable first-order IIR*/
#define LSBS_N0_ADC_IIR				(PAGE_4+9)
/*8 MSBs of N1 coefficient for ADC-programmable first-order IIR*/
#define MSBS_N1_ADC_IIR				(PAGE_4+10)
/*8 LSBs of N1 coefficient for ADC-programmable first-order IIR*/
#define LSBS_N1_ADC_IIR				(PAGE_4+11)
/*8 MSBs of D1 coefficient for ADC-programmable first-order IIR*/
#define MSBS_D1_ADC_IIR				(PAGE_4+12)
/*8 LSBs of D1 coefficient for ADC-programmable first-order IIR*/
#define LSBS_D1_ADC_IIR				(PAGE_4+13)
/*Coefficient N0(15:8)for ADC biquad A or coeffient FIR0(15:8)for ADC FIR filter*/
#define COEF_N0_ADC_A_15			(PAGE_4+14)
/*Coefficient N0(7:0)for ADC biquad A or coeffient FIR0(7:0)for ADC FIR filter*/
#define COEF_N0_ADC_A_7				(PAGE_4+15)
/*Coefficient N1(15:8)for ADC biquad A or coeffient FIR1(15:8)for ADC FIR filter*/
#define COEF_N1_ADC_A_15			(PAGE_4+16)
/*Coefficient N1(7:0)for ADC biquad A or coeffient FIR1(7:0)for ADC FIR filter*/
#define COEF_N1_ADC_A_7				(PAGE_4+17)
/*Coefficient N2(15:8)for ADC biquad A or coeffient FIR2(15:8)for ADC FIR filter*/
#define COEF_N2_ADC_A_15			(PAGE_4+18)
/*Coefficient N2(7:0)for ADC biquad A or coeffient FIR2(7:0)for ADC FIR filter*/
#define COEF_N2_ADC_A_7				(PAGE_4+19)
/*Coefficient D1(15:8)for ADC biquad A or coeffient FIR3(15:8)for ADC FIR filter*/
#define COEF_D1_ADC_A_15			(PAGE_4+20)
/*Coefficient D1(7:0)for ADC biquad A or coeffient FIR3(7:0)for ADC FIR filter*/
#define COEF_D1_ADC_A_7				(PAGE_4+21)
/*Coefficient D2(15:8)for ADC biquad A or coeffient FIR4(15:8)for ADC FIR filter*/
#define COEF_D2_ADC_A_15			(PAGE_4+22)
/*Coefficient D2(7:0)for ADC biquad A or coeffient FIR4(7:0)for ADC FIR filter*/
#define COEF_D2_ADC_A_7				(PAGE_4+23)
/*Coefficient N0(15:8)for ADC biquad B or coeffient FIR5(15:8)for ADC FIR filter*/
#define COEF_N0_ADC_B_15			(PAGE_4+24)
/*Coefficient N0(7:0)for ADC biquad B or coeffient FIR5(7:0)for ADC FIR filter*/
#define COEF_N0_ADC_B_7				(PAGE_4+25)
/*Coefficient N1(15:8)for ADC biquad B or coeffient FIR6(15:8)for ADC FIR filter*/
#define COEF_N1_ADC_B_15			(PAGE_4+26)
/*Coefficient N1(7:0)for ADC biquad B or coeffient FIR6(7:0)for ADC FIR filter*/
#define COEF_N1_ADC_B_7				(PAGE_4+27)
/*Coefficient N2(15:8)for ADC biquad B or coeffient FIR7(15:8)for ADC FIR filter*/
#define COEF_N2_ADC_B_15			(PAGE_4+28)
/*Coefficient N2(7:0)for ADC biquad B or coeffient FIR7(7:0)for ADC FIR filter*/
#define COEF_N2_ADC_B_7				(PAGE_4+29)
/*Coefficient D1(15:8)for ADC biquad B or coeffient FIR8(15:8)for ADC FIR filter*/
#define COEF_D1_ADC_B_15			(PAGE_4+30)
/*Coefficient D1(7:0)for ADC biquad B or coeffient FIR8(7:0)for ADC FIR filter*/
#define COEF_D1_ADC_B_7				(PAGE_4+31)
/*Coefficient D2(15:8)for ADC biquad B or coeffient FIR9(15:8)for ADC FIR filter*/
#define COEF_D2_ADC_B_15			(PAGE_4+32)
/*Coefficient D2(7:0)for ADC biquad B or coeffient FIR9(7:0)for ADC FIR filter*/
#define COEF_D2_ADC_B_7				(PAGE_4+33)



/***************** Page 8 Registers******************************************/
#define PAGE_8                     1024
/*DAC Coefficient Buffer Control*/
#define MINIDSP_DAC_CONTROL			(PAGE_8+1)
/*8 MSBs of n0 coefficient for left DAC-programmable biquad A*/
#define MSB_N0_LDAC_A				(PAGE_8+2)
/*8 LSBs of n0 coefficient for left DAC-programmable biquad A*/
#define LSB_N0_LDAC_A				(PAGE_8+3)
/*8 MSBs of n1 coefficient for left DAC-programmable biquad A*/
#define MSB_N1_LDAC_A				(PAGE_8+4)
/*8 MSBs of n1 coefficient for left DAC-programmable biquad A*/
#define LSB_N1_LDAC_A				(PAGE_8+5)
/*8 MSBs of n2 coefficient for left DAC-programmable biquad A*/
#define MSB_N2_LDAC_A				(PAGE_8+6)
/*8 LSBs of n2 coefficient for left DAC-programmable biquad A*/
#define LSB_N2_LDAC_A				(PAGE_8+7)
/*8 MSBs of d1 coefficient for left DAC-programmable biquad A*/
#define MSB_D1_LDAC_A				(PAGE_8+8)
/*8 LSBs of d1 coefficient for left DAC-programmable biquad A*/
#define LSB_D1_LDAC_A				(PAGE_8+9)
/*8 MSBs of d2 coefficient for left DAC-programmable biquad A*/
#define MSB_D2_LDAC_A				(PAGE_8+10)
/*8 LSBs of d2 coefficient for left DAC-programmable biquad A*/
#define LSB_D2_LDAC_A				(PAGE_8+11)
 ...
 *----------------------------------------------------------------------------
 */
//extern struct snd_soc_dai_driver tlv320aic3111_dai;
 ...
 *
 */
//extern struct snd_soc_codec_driver soc_codec_dev_aic3111;
