...
#define OMAP_VENDOR_ID          0x17EF

#if defined(CONFIG_USB_PRODUCT_ID_A1_07)

#define OMAP_UMS_PRODUCT_ID		0x7421
#define OMAP_UMS_ADB_PRODUCT_ID		0x7423
#define OMAP_RNDIS_PRODUCT_ID		0x7422
#define OMAP_RNDIS_ADB_PRODUCT_ID	0x7422
#else
#error Please configure PAD product ID
#endif 
...
static void usb_gadget_init(void)
{
	...
	/* keep the same */
	snprintf(device_serial, MAX_USB_SERIAL_NUM,
				"7DF000029EDC0000");
