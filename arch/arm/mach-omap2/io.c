...
static void __init _omap2_map_common_io(void)
{
	...
	omap_sram_init();
    reserve_bootmem(UPGRADE_MEM_BASE, UPGRADE_MEM_SIZE, BOOTMEM_DEFAULT);
/*	ret = __alloc_bootmem(UPGRADE_MEM_SIZE, PAGE_SIZE, UPGRADE_MEM_BASE);
	
	printk("************AAAAAAAAAAAAAAAAAAAA**********ret virt = %8x\n", ret);

	ret = virt_to_phys(ret);
	
	printk("************AAAAAAAAAAAAAAAAAAAA**********ret phys = %8x\n", ret);
...
//        reserve_bootmem(UPGRADE_MEM_BASE, UPGRADE_MEM_SIZE, BOOTMEM_EXCLUSIVE);
	omapfb_reserve_sdram();
	omap_vram_reserve_sdram();
	dspbridge_reserve_sdram();
//      reserve_bootmem(UPGRADE_MEM_BASE, UPGRADE_MEM_SIZE, BOOTMEM_DEFAULT);
	//__alloc_bootmem(UPGRADE_MEM_SIZE, PAGE_SIZE, UPGRADE_MEM_BASE);
//	omapug_reserve_mem();
